...
<div class="wrapper">
		...
		<button type="button" id="sidebarCollapse" class="btn btn-info">
				...
				<span>Menu</span>
			</button><b>&nbsp&nbsp&nbsp&nbsp&nbspAgenda</b>
			<br><br><button class="btn btn-success waves-effect waves-light" data-id='0' data-toggle="modal" data-target="#tambah-databerita"><i class="glyphicon glyphicon-plus"></i> Agenda</button>
