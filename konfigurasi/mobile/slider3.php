...
if (isset($_POST['tambahslide'])) {
    if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') {
		$lokasi='C:/xampp/htdocs/darq/konfigurasi/gambar/slide-kiri-bawah/';
	} else {
		$lokasi='/var/www/konfigurasi/gambar/slide-kiri-bawah/';
	}
...
elseif (isset($_POST['edit'])) {
    ...
    if ($judul!=NULL){
        unlink($hapus_slider);   
		if (move_uploaded_file($_FILES['gambar']['tmp_name'], $uploadfile)){
			mysqli_query($con, "UPDATE `kiri_bawah` SET `keterangan`='$keterangan', `judul`='$judul' WHERE id=$id");
		}
    }
    else{
        mysqli_query($con, "UPDATE `kiri_bawah` SET `keterangan`='$keterangan' WHERE id=$id");
    }
}
?>
<html>
    ...
    <div class="wrapper">
        ...
        <div id="content">
			...
			<button type="button" id="sidebarCollapse" class="btn btn-info">
				...
				<span>Menu</span>
			</button><b>&nbsp&nbsp&nbsp&nbsp&nbspSlide Kiri Bawah</b>
			...
			<tbody>
				...
				while ($row1 = mysqli_fetch_array($query)) {
					...
					<tr class="gradeX">
						...
						<td style="vertical-align: middle;"><img src="../gambar/slide-kiri-bawah/<?php echo $row1[2];?>" class="img-responsive" width="100vw"></td>
