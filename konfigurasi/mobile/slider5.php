    ...
    <div class="wrapper">
        ...
        <div id="content">
			...
			<button type="button" id="sidebarCollapse" class="btn btn-info">
				...
				<span>Menu</span>
			</button><b>&nbsp&nbsp&nbsp&nbsp&nbspSlide Kanan Bawah</b>
			...
			<tbody>
				...
				while ($row1 = mysqli_fetch_array($query)) {
					...
					<tr class="gradeX">
						...
						<td style="vertical-align: middle;"><img src="../gambar/slide-kanan-bawah/<?php echo $row1[2];?>" class="img-responsive" width="100vw"></td>
